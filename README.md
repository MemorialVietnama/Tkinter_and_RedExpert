...
```
git clone https://gitflic.ru/project/bruno33/red-expert-and-tkinter.git
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/bruno33/red-expert-and-tkinter.git
git clone
