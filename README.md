...
- [Принцип и назначение проекта](#принцип-и-назначение-проекта)
    - [Структура проекта](#структура-проекта)
- [Окно авторизации](#окно-авторизации)
    - [Функция проверки подключения к базе данных](#функция-проверки-подключения-к-базе-данных)
    - [Код Tkinter в окне авторизации](#код-tkinter-в-окне-авторизации)
- [Окно Администратора (Особенности работы с таблицами)](#окно-администратора-особенности-работы-с-таблицами)
    - [Журнал Аудита](#журнал-аудита)
    - [Кнопка Обновить и Поиск](#кнопка-обновить-и-поиск)
- [Отображение данных пользователя в заголовке окна приложения](#отображение-данных-пользователя-в-заголовке-окна-приложения)
- [Окно пользователя USER_MODE.py](#окно-пользователя-user_modepy)
    - [Формирование постов на странице Tkinter](#формирование-постов-на-странице-tkinter)
- [Работа с таблицей данных](#работа-с-таблицей-данных)
    - [Отображение таблицы](#отображение-таблицы)
        - [Добавление функционала Добавить, Удалить, Изменить](#добавление-функционала-добавить-удалить-изменить)
            - [Добавление строк в таблицу](#добавление-строк-в-таблицу)
            - [Удаление строк из таблицы](#удаление-строк-из-таблицы)
            - [Изменение строк в таблице](#изменение-строк-в-таблице)
            - [Обновление таблицы](#обновление-таблицы)
- [Функционал создания PDF документов из данных таблиц](#функционал-создания-pdf-документов-из-данных-таблиц)
    - [Основная логика](#основная-логика)
    - [Описание библиотек](#описание-библиотек)
    - [Работа в приложении](#работа-в-приложении)
- [Итог](#итог)

## Интересное об Tkinter и  Red Expert
 - [Функция проверки подключения к базе данных](#функция-проверки-подключения-к-базе-данных)
 - [Окно Администратора (Особенности работы с таблицами)](#окно-администратора-особенности-работы-с-таблицами)
    - [Журнал Аудита](#журнал-аудита)
    - [Кнопка Обновить и Поиск](#кнопка-обновить-и-поиск)
